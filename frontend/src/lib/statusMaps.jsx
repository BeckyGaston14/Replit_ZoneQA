...
export const RESULT_STATUSES = Object.fromEntries(
  Object.entries({
    ...
    "Pass with Notes": "Legacy label normalized to Pass with Minor Issues.",
    ...
    Partial: "Legacy label normalized to Needs Improvement.",
...
export const RELEASE_DECISIONS = {
  ...
  "INSUFFICIENT-EVIDENCE": { label: "Insufficient Evidence", color: "#64748b", icon: AlertTriangle, description: "The minimum qualifying evidence threshold has not been met; release readiness remains neutral." },
...
export const COVERAGE_STATUSES = {
  ...
  partially_evaluated: { label: "Partially Evaluated", color: "#0369a1", icon: AlertTriangle, description: "Some, but not all, active test definitions have a qualifying completed evaluation." },
  fully_evaluated: { label: "Fully Evaluated", color: "#15803d", icon: CheckCircle2, description: "Every active test definition has a qualifying completed evaluation." },
};
